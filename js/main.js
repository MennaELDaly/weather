...
async function getWeatherData(currentCity='cairo'){
   apiResopnse = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=59536522814349dbb5564543230903&q=${currentCity}&days=3`);
   responseData = await apiResopnse.json();
